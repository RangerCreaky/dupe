...
const Register = () => {
  ...
  const submit = (e) => {
    ...
    if (password !== cnfPassword) {
      dispatch(alert({ type: 'red', msg: 'passwords does not match' }));
      emptyValues();
      return;
    }
      ...
      <div className="h-screen md:flex">
        ...
        <div className="flex md:w-1/2 justify-center py-10 items-center bg-white">
          <form className="bg-white w-1/2" onSubmit={submit}>
            <h1 className="text-[#D2AC47] font-bold text-2xl mb-1">Register </h1>
            <p className="text-sm font-normal text-[#D2AC47] mb-7">Welcome to Venus beads!</p>
